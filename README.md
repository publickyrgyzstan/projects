Вы находитесь в главной ветке разработки, до принятия закона о люстрации файл будет содержать лиш этот вводный текст. Разработка ведется в алтернативных ветках, например:
