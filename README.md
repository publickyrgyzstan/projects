...
Лицам, указанным в статье 2 "Кто не допускается" настоящего закона запрещается занимать должности, указанные в статье 5."Должности, на которые не принимаются лица с ограничениями". 
